...
Malicious samples are generated from RO-based designs. These designs place attacker-controlled ring oscillators into the reconfigurable region. The RO count is varied to create payloads with different logic footprints~\cite{la2020fpgadefender,provelengios2020power,chaudhuri2023criticality}. This allows the evaluation to distinguish between small low-footprint payloads and larger high-density payloads.
...
\begin{figure}[t]
    \centering
    \resizebox{\linewidth}{!}{\input{figures/ro_count_distribution.tikz}}
    \caption{Distribution of RO counts in the normal-RO dataset and the big-RO extension. Bars count available bitstream samples at each RO-count setting.}
