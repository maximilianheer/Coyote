...
The preprocessing step converts each partial bitstream into the fixed input shape expected by the CNN. Related work has used bitstream-derived tensors or image-like transforms for FPGA classification tasks~\cite{rettkowski2019inspection,chaudhuri2022detection,chen2020bitstreamimage}. The transform used here is intentionally simple. It does not reverse-engineer the bitstream. It does not extract hand-crafted circuit features. It treats the partial bitstream as a byte stream.
