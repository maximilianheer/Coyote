...
\begin{table}[t]
    ...
    \begin{tabular}{p{0.28\linewidth} p{0.62\linewidth}}
        ...
        \midrule
        CNN-only evaluation &
        Other hardware-friendly classifiers may provide better latency or resource tradeoffs. \\
        \midrule
        ...
        \midrule
        Partial integration &
        The checker is synthesized and placed in a Coyote path, but it is not yet a complete production component. \\
        \bottomrule
    \end{tabular}
\end{table}
...
The final implementation step would be full Coyote integration. The checker should be connected directly to the PR control path, with threshold policy, logging, error handling, and a clear response for low-confidence predictions. This would turn the current prototype into a complete in-path security gate.
