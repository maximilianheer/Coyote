...
set_property -dict [list CONFIG.C_PROBE3_WIDTH {512} CONFIG.C_PROBE4_WIDTH {64} CONFIG.C_PROBE8_WIDTH {512} CONFIG.C_PROBE9_WIDTH {64} CONFIG.C_PROBE13_WIDTH {512} CONFIG.C_PROBE14_WIDTH {64} CONFIG.C_PROBE17_WIDTH {128} CONFIG.C_PROBE18_WIDTH {48} CONFIG.C_PROBE19_WIDTH {48} CONFIG.C_PROBE20_WIDTH {48} CONFIG.C_PROBE21_WIDTH {48} CONFIG.C_PROBE22_WIDTH {48} CONFIG.C_PROBE23_WIDTH {32} CONFIG.C_PROBE24_WIDTH {4} CONFIG.C_PROBE26_WIDTH {32} CONFIG.C_PROBE28_WIDTH {4} CONFIG.C_PROBE29_WIDTH {32} CONFIG.C_PROBE30_WIDTH {64} CONFIG.C_PROBE34_WIDTH {512} CONFIG.C_PROBE35_WIDTH {64} CONFIG.C_PROBE37_WIDTH {32} CONFIG.C_PROBE39_WIDTH {32} CONFIG.C_PROBE40_WIDTH {16} CONFIG.C_PROBE41_WIDTH {32} CONFIG.C_PROBE42_WIDTH {32} CONFIG.C_PROBE46_WIDTH {32} CONFIG.C_NUM_OF_PROBES {47} CONFIG.C_DATA_DEPTH {4096} CONFIG.C_EN_STRG_QUAL {1} CONFIG.ALL_PROBE_SAME_MU_CNT {2}] [get_ips ila_host_networking]

# New host networking ILA on the AXI-streams
create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name ila_host_networking_axis
set_property -dict [list CONFIG.C_PROBE3_WIDTH {512} CONFIG.C_PROBE4_WIDTH {64} CONFIG.C_NUM_OF_PROBES {5} CONFIG.C_DATA_DEPTH {16384} CONFIG.C_EN_STRG_QUAL {1} CONFIG.ALL_PROBE_SAME_MU_CNT {2}] [get_ips ila_host_networking_axis]
